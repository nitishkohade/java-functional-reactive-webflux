...
public class WorkerSpliterator implements Spliterator<Worker> {
	...
	public WorkerSpliterator(Spliterator<String> wordSpliterator) {
		this.wordSpliterator = wordSpliterator;
	}

	@Override
	public boolean tryAdvance(Consumer<? super Worker> action) {
		if(
			...
			action.accept(new Worker(this.id, 
					this.name, 
					this.gender, 
					this.dob,
					this.city, 
	...
	@Override
	public Spliterator<Worker> trySplit() {
